        ...
        child: Container(
          ...
          child: Center(
            child: Column(
              ...
              children: [
                Lottie.asset(lottie),
                Text("See your result", style: MyTextStyles.inter900.copyWith(color: MyColors.C_FCA82F, fontSize: 22.sp),),
                SizedBox(height: 25.h),
                Text("${widget.trueQuestionsCount} / ${widget.totalQuestionsCount}",
                    style: MyTextStyles.inter900
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    return Padding(
                      ...
                      child: ResultItem(text: "Question: ${index + 1}", isTrue: widget.answers[index]),
                    );
