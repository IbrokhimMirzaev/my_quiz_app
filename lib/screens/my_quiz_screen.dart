    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Start Test",
            style: MyTextStyles.inter700
                .copyWith(color: Colors.white, fontSize: 22.sp)),
        actions: [
          SvgPicture.asset(MyIcons.purpleWalletSvg, height: 35.h, width: 35.h),
          SizedBox(width: 10.w),
        ],
        centerTitle: true,
        elevation: 0,
            ...
            child: Column(
              ...
              children: [
                Text(widget.quizName,
                    style: MyTextStyles.inter500.copyWith(fontSize: 20.sp)),
                  ...
                  child: ListView(
                    children: [
                      Text(
                        ...
                        style: MyTextStyles.inter500.copyWith(
                            fontSize: 25.sp, color: MyColors.C_4047C1),
                      ),
                      SizedBox(height: 10.h),
                      Text(
                        widget.quizList[currentQuestionIndex].questionText,
                        style: MyTextStyles.inter500.copyWith(fontSize: 22.sp),
                      ),
                          ...
                          if (currentQuestionIndex + 1 <
                            ...
                            Navigator.pushReplacement(context,
                              ...
                              return ResultScreen(
                                ...
                                percentage: trueQuestionsCount / widget.quizList.length * 100,
                              );
                            }));
                          }
                        } else {
