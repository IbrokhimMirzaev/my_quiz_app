import '../model/quizData_class.dart';
...
class QuizRepository {
  ...
  static List<QuizData> mathSet() {
    ...
    test.add(QuizData(
      questionText: "Cheksiz kamayuvchi geometrik progressiya bo'lishlik sharti?",
      v1: "A. |q| < 1",
      v2: "B. q > 0",
      v3: "C. |q| < 0",
    ...
    test.add(QuizData(
      questionText: "Vatarga perpendikulyar diametr shu vatarni va unga tiralgan yoyni teng ______ bo'ladi.",
      v1: "A. uchga",
      v2: "B. ikkiga",
      v3: "C. to'rt bo'lakka",
    ...
    test.add(QuizData(
      questionText: "Ko'pburchakning ichki burchaklar yig'indisi qanday topiladi? (formulasi)",
      v1: "A. n - 3 ",
      v2: "B. n * (n - 3) / 2",
      v3: "C. 180 * (n - 2)",
    ...
    test.add(QuizData(
      questionText: "Aylanada olingan n ta nuqtadan nechta kesma o'tkazish mumkin?",
      v1: "A. n * (n - 1) / 2  ta",
      v2: "B. n - 1  ta ",
  ...
  static List<QuizData> sportSet() {
    ...
    test.add(QuizData(
      questionText: "How many goals Ronaldo scored for Real Madrid in Champions League?",
      v1: "A. 100",
      v2: "B. 105",
      v3: "C. 200",
      v4: "D. 180",
